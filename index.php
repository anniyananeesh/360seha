...
if(!in_array($subdomain_name, array('emirates','kuwait','bahrain','saudi-arabia','oman','qatar')))
{
	...
	switch($countryCode)
	{
      	...
      	case 'BH':
        	header('Location:http://bahrain.360seha.com');
      	break;

      	case 'QA':
        	header('Location:http://qatar.360seha.com');
      	break;

      	case 'SA':
        	header('Location:http://saudi-arabia.360seha.com');
      	break;

      	default: header('Location:http://emirates.360seha.com');
 	}
}*/
...
define('ENVIRONMENT', (getenv('APPLICATION_ENV')) ? getenv('APPLICATION_ENV') : 'testing');
/*
 *---------------------------------------------------------------
 * ERROR REPORTING
 *---------------------------------------------------------------
