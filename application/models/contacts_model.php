...
class Contacts_model extends Base_model {
    ...
    public function get_contacts($condition = array(), $orderBy = array(), $limit = null, $offset = null, $join = array())
    {
    ...
    /*
     * 
     * Get contacts count from table as per list pk passed
     * @params $list_id
     * 
     * Primary Key for contacts table
     */
    public function get_contact_count( $condition = array()){
