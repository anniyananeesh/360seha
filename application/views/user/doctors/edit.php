						...
						<div class="col-10">
							...
							<div class="col-60">
								...
								<div class="col-5">
									<div class="setup-form-group block">
										<?php if(!empty($image)):?>
											<img src="<?php echo $imageShowPath.$image?>" style="margin-bottom: 15px;" width="100" class="left"/>
										<?php endif;?>
										<div style=" padding-left: 110px; padding-right: 110px; padding-top: 30px; line-height: 22px;">
