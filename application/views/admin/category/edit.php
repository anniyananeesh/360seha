                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                          ...
                          <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('c_title')):?> has_error<?php endif;?>" name="c_title" id="c_title" value="<?php echo $record->name;?>"/>
                      ...
                      <div class="col-sm-2 p-t-sm">
                          ...
                          <input type="text" autofocus autocomplete="off" class="form-control" name="c_title_ar" id="c_title" value="<?php echo $record->name_ar;?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <button type="button" class="btn btn-default" onclick="javascript: location.href='<?php echo base_url().ADMIN_URL?>category/'">Cancel</button>
