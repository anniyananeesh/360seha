                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="post"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          <input type="text" autofocus autocomplete="off" class="form-control" name="name" id="name" value="<?php echo $record->reg_name;?>"/>
                      ...
                      <div class="col-sm-4">
                          <select class="chosen-select" name="city" id="city" style="width: 250px;"/>
                            ...
                            <?php foreach($cities as $c):?>
                                ...
                                <option value="<?php echo $_id;?>" <?php echo ($record->city_pk == $c->id) ? 'selected = "selected"' : '';?>><?php echo $c->name;?></option>
                            <?php endforeach;?>
