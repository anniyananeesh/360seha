                    ...
                    <div class="form-group">
                        	...
                        	<div class="clearfix"></div>
	                      	<div class="col-sm-4">
	                      		...
	                      		<label>English</label>
	                          	<input type="text" autofocus autocomplete="off" class="form-control" name="title" id="title" value="<?php echo $record->dept_title;?>"/>
	                      	...
	                      	<div class="col-sm-4 p-t-md">
	                      		...
	                      		<label>Arabic</label>
	                          	<input type="text" autofocus autocomplete="off" class="form-control" name="title_ar" id="title_ar" value="<?php echo $record->dept_title_ar;?>"/>
