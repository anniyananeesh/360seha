                  ...
                  <form class="form-horizontal" method="post"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                            ...
                            <div class="col-md-5">
                              ...
                              <label>English</label>
                              <input type="text" autofocus autocomplete="off" class="form-control" name="name" id="name" value="<?php echo $record->name;?>"/>
                          ...
                          <div class="col-md-5">
                              ...
                              <label>Arabic</label>
                              <input type="text" autofocus autocomplete="off" class="form-control" name="name_ar" id="name_ar" value="<?php echo $record->name_ar;?>"/>
                    ...
                    <div class="form-group">
                      <div class="col-sm-4 col-sm-offset-2">
                        <button type="button" class="btn btn-default btn-rounded" onclick="javascript: location.href='<?php echo base_url()?>admin/city/'">Cancel</button>
