                      ...
                      <?php if($records):?>
                        ...
                        <?php foreach ($records as $n):?>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php $_id = $this->encrypt->encode($n->articles_id);?>
                              <?php echo ($n->title == NULL) ? $n->title_ar: $n->title;?>
                              </td>
                              <td>
                                <img src="<?php echo ARTICLES_SHOW_PATH?><?php echo $n->image_url?>" width="150" class="b b-gray img-responsive"/>
                              </td>
