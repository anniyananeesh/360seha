                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        ...
                        <?php if(isset($record->image_url)):?>
                            <img src="<?php echo ARTICLES_SHOW_PATH?><?php echo $record->image_url?>" class="m-b-md b b-success"/>
                        <?php endif;?>
                        ...
                        <div class="help-block">
                            Upload the Wall Image file | Allowed *.jpg, *.png | Res. 750 X 500 Pixels  | Maximum File Size 1MB
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 editor-container">
                          ...
                          <textarea name="description" class="form-control editor" style="overflow:scroll;height:200px;"><?php echo $record->description;?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 editor-container">
                          ...
                          <textarea name="description_ar" class="form-control editor" style="overflow:scroll;height:200px;"><?php echo $record->description_ar;?></textarea>
                           <div class="clearfix"></div>
