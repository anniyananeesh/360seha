                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        	...
                        	<div class="clearfix"></div>
	                      	<div class="col-sm-4">
	                      		...
	                      		<label>English</label>
	                          	<input type="text" autofocus autocomplete="off" class="form-control" name="title" id="title" value="<?php echo $record->tips_title;?>"/>
	                      	...
	                      	<div class="col-sm-4 p-t-md">
	                      		...
	                      		<label>Arabic</label>
	                          	<input type="text" autofocus autocomplete="off" class="form-control" name="title_ar" id="title_ar" value="<?php echo $record->tips_title_ar;?>"/>
	                           <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        ...
                        <?php if(isset($record->thumb_url) && $record->thumb_url != NULL):?>
                            <img src="<?php echo base_url()?>uploads/tips/<?php echo $record->thumb_url?>" class="m-b-md b b-success"/>                         
                        <?php endif;?> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 editor-container">
                          ...
                          <textarea name="description" class="form-control editor" style="overflow:scroll;height:200px;"><?php echo $record->tips_description;?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 editor-container">
                          ...
                          <textarea name="description_ar" class="form-control editor" style="overflow:scroll;height:200px;"><?php echo $record->tips_description_ar;?></textarea>
                          <div class="clearfix"></div>
