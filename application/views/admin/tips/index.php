                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                      ...
                      <?php if($records):?>
                        ...
                        <?php foreach ($records as $tip):?>
                        
                            <tr>
                              
                              <td>
                                <?php $_id = $this->encrypt->encode($tip->tips_id);?>
                              <?php echo ($tip->tips_title != NULL) ? $tip->tips_title : $tip->tips_title_ar;?>
                              </td>
                              <td>
                                <img src="<?php echo base_url()?>uploads/tips/<?php echo $tip->thumb_url?>" width="150" class="b b-gray img-responsive"/>
                              </td>
                              ...
                              <td><?php echo date('d F Y', strtotime($tip->created_on))?></td>
                              <td>
