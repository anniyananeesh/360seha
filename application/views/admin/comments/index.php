<section class="scrollable padder">
    ...
    <form method="post" name="search">
        <div class="row" style="margin-top: 15px; margin-bottom: 15px;"> 
            ...
            <div class="col-sm-3" style="width: 440px;">
                <select style="width: 430px" class="chosen-select pull-left m-l-md" name="subscriber" id="subscriber"/>
                    ...
                    <?php foreach($subscribers as $user):?>
                        ...
                        <option value="<?php echo $_id;?>" <?php echo set_select('subscriber', $_id)?>><?php echo $user->subs_title;?></option>
                    <?php endforeach;?>
            ...
            <div class="col-sm-3">
                <button class="btn btn-sm btn-primary" type="submit">Search Comments!</button>
            </div>
            ...
            <tbody>
              ...
              <?php if($comments):?>
                ...
                <?php foreach ($comments as $comment):?>
                    ...
                    <tr>
                      <td>
                          <?php $_id = $this->encrypt->encode($comment->id);?>
                          <?php echo $comment->subs_title;?>
                      </td>
                      <td> 
                      ...
                      <td><?php echo date('d F Y', strtotime($comment->created_on))?></td>
                      <td>
