<section class="scrollable padder">
    ...
    <?php if(isset($message)):?>
        ...
        <div class="alert alert-success h4 font-thin">
                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="post"> 
                    ...
                    <div class="row wrapper padder">
                        ...
                        <label class="col-sm-2 control-label"><strong>Find the Subscriber <span class="required-txt">*</span></strong></label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-2 control-label"><strong>From Name <span class="required-txt">*</span></strong></label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><strong>From Email: <span class="required-txt">*</span></strong></label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          ...
                          <input type="text" autofocus autocomplete="off" class="form-control" name="nl_subject" id="nl_subject" value="<?php echo set_value('nl_subject');?>"/>
                    ...
                    <div class="form-group">
                      <div class="col-sm-4 col-sm-offset-2">
                        <button type="submit" class="btn btn-success btn-lg btn-rounded font-thin">Send Mail</button>
                      </div>
                    </div>
