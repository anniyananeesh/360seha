                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="post" enctype="multipart/form-data"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <div class="col-md-5">
                              ...
                              <label>English</label>
                              <input type="text" autofocus autocomplete="off" class="form-control" name="name_en" id="name_en" value="<?php echo set_value('name_en');?>"/>
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <div class="col-md-5"> 
                              <input type="text" autofocus autocomplete="off" class="form-control" name="domain_url" id="domain_url" value="<?php echo set_value('domain_url');?>"/>
