                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        ...
                        <?php if(isset($record->image_url) && $record->image_url != NULL):?>
                            <img src="<?php echo base_url()?>uploads/appslides/<?php echo $record->image_url?>" class="m-b-md b b-success"/>                 
                        <?php endif;?> 
                        ...
                        <div class="help-block">
                            Upload the Wall Image file | Allowed *.jpg, *.png | Res. 640 X 400 Pixels  | Maximum File Size 800KB                      
                        </div>
                      ...
                      <div class="col-sm-12">
                              ...
                              <select class="chosen-select" name="dept_fk[]" id="dept_fk" style="width:350px;" multiple="true"/>
                                  <?php foreach($department AS $data):?>
                                    <option value="<?php echo $data->dept_id;?>" <?php echo (in_array($data->dept_id, $chosen_department)) ? 'selected' : '';?>><?php echo $data->dept_title;?></option>
                                  <?php endforeach;?>
                              </select>
