                        ...
                        <?php foreach ($records as $data):?>
                            ...
                            <tr> 
                              <td>
                                ...
                                <img src="<?php echo base_url()?>uploads/appslides/<?php echo $data->image_url?>" width="150" class="b b-gray img-responsive"/>
                              </td> 
                              <td>
                              <?php 

                                  //$CI = & get_instance();
                                  //$CI->load->model('admin/slide_dept_model','modelSlideDeptAlias');
                                  $departments = $this->modelSlideDeptAlias->getDeptsNameFromBannerId($data->id);
                                  echo (!empty($departments)) ? implode(',', $departments) : '';
                              ?></td>
                              <td>
