<section class="scrollable padder">
    <div class="m-b-md">
        <h3 class="m-b-none font-thin"><i class="i i-ccw"></i> <?php echo $title;?></h3>
                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="post"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          <input type="text" autofocus autocomplete="off" class="form-control" name="list_title" id="list_title" value="<?php echo $record->list_title;?>"/>
