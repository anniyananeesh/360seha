        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data"> 
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-sm-4">
                        <label>English</label>
                        <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('name_en')):?>has-error<?php endif;?>" name="name_en" id="name_en" value="<?php echo (isset($post) && $post["name_en"] != "") ? $post['name_en'] : '';?>"/>
                    ...
                    <div class="col-sm-4 p-t-md">
                        <label>Arabic</label>
                        <input type="text" autofocus autocomplete="off" class="form-control txt-AlignARtl <?php if(form_error('name_ar')):?>has-error<?php endif;?>" name="name_ar" id="name_ar" value="<?php echo (isset($post) && $post["name_ar"] != "") ? $post['name_ar'] : '';?>"/>
                    </div>
                    <div class="clearfix"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <select style="width:360px; padding: 5px 8px;" name="category" id="category"/>
                            ...
                            <option value="<?php echo $data->id_category?>" <?php echo (isset($post) && ($post["category"] != "" && $post["category"] == $data->id_category)) ? 'selected' : '';?>><?php echo $data->name_en?></option>
                            <?php endforeach;?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="clearfix"></div>
                    <div class="col-sm-4"> 
                        <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('email')):?>has-error<?php endif;?>" name="email" id="email" value="<?php echo (isset($post) && $post["email"] !== "") ? $post['email'] : '';?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="clearfix"></div>
                    <div class="col-sm-4"> 
                        <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('contact_no')):?>has-error<?php endif;?>" name="contact_no" id="contact_no" value="<?php echo (isset($post) && $post["contact_no"] != "") ? $post['contact_no'] : '';?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4"> 
                        ...
                        <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('latitude')):?>has-error<?php endif;?>" name="latitude" id="latitude" value="<?php echo (isset($post) && $post["latitude"] != "") ? $post['latitude'] : '';?>"/>
                    ...
                    <div class="col-sm-4"> 
                        ...
                        <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('longitude')):?>has-error<?php endif;?>" name="longitude" id="longitude" value="<?php echo (isset($post) && $post["longitude"] != "") ? $post['longitude'] : '';?>"/>
                ...
                <div class="line line-dashed b-b line-lg pull-in"></div> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 editor-container">
                          <textarea name="description_en" id="description_en" class="form-control" style="overflow:scroll;height:140px;"><?php echo (isset($post) && $post["description_en"] != "") ? $post['description_en'] : '';?></textarea>
                          <div class="clearfix"></div>
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        ...
                        <?php if(isset($image_url) && $image_url != NULL):?>
                            <img src="<?php echo $image_show_path?><?php echo $image_url?>" class="m-b-md b b-success"/>                 
                        <?php endif;?>
                        <div class="clearfix"></div>
