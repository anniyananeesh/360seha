                    ...
                    <div class="form-group">
                        	...
                        	<div class="clearfix"></div>
	                      	<div class="col-sm-4">
	                      		...
	                      		<label>English</label>
	                          	<input type="text" autofocus autocomplete="off" class="form-control" name="title_en" id="title_en" value="<?php echo $record->title_en;?>"/>
                    	...
                    	<div class="col-sm-12">
                              ...
                              <select class="chosen-select" name="dept_fk" id="dept_fk"/>
                                  <?php foreach($department AS $data):?>
                                    <option value="<?php echo $data->dept_id;?>" <?php echo ($data->dept_id == $record->dept_id) ? 'selected' : '';?>><?php echo $data->dept_title;?></option>
                                  <?php endforeach;?>
                              </select>
