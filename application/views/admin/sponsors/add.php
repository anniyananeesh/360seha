                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 p-t-sm">
                          ...
                          <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('title_ar')):?>has-error<?php endif;?>" name="title_ar" id="title_ar" value="<?php echo set_value('title_ar');?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="clearfix"></div>
                      <div class="col-sm-6"> 
                          <input type="text" autofocus autocomplete="off" class="form-control <?php if(form_error('url')):?>has-error<?php endif;?>" name="url" id="url" value="<?php echo set_value('url');?>"/>
