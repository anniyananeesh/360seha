                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="post"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          <input type="text" autofocus autocomplete="off" class="form-control" name="first_name" id="first_name" value="<?php echo $record->first_name;?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          <input type="text" autofocus autocomplete="off" class="form-control" name="last_name" id="last_name" value="<?php echo $record->last_name;?>"/>
                      ...
                      <div class="col-sm-10">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <p class="h4 font-bold"><?php echo $record->user_name?></p>
                          </div> 
                        </div> 
                          ...
                          <div class="col-md-3">
                                ...
                                <select style="width:360px" class="chosen-select" name="grp"/>
                                    ...
                                    <?php foreach ($groups as $grp):?>
                                        <option value="<?php echo $grp->grp_id?>" <?php if($grp->grp_id == $record->grp_id):?> selected="selected"<?php endif;?>><?php echo $grp->grp_title?></option>
                                    <?php endforeach;?>
                                </select>
