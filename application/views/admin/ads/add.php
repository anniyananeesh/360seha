          ...
          <?php echo $sub_title;?>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          <input type="text" autofocus autocomplete="off" class="form-control" name="title" id="list_title" value="<?php echo set_value('title');?>"/>
                      ...
                      <div class="col-sm-4">
                          ...
                          <div class="col-sm-12">
                            <label class="switch left">
                                <input type="checkbox" value="1" name="is_google_adsense" id="is_google_adsense" <?php if($show_ad_sense):?> checked <?php endif;?>>
                               <span></span>
                            </label> 
                    ...
                    <div id="show_img_ad_upld" <?php if($show_ad_sense):?> style="display: none;"<?php else:?> style="display: block;"<?php endif;?>>
                        ...
                        <div class="col-sm-4">
                          <input type="text" autofocus autocomplete="off" class="form-control" name="url" id="url" value=""/>
                    ...
                    <div id="show_google_adsense_scrpt" <?php if($show_ad_sense):?> style="display: block;"<?php else:?> style="display: none;"<?php endif;?>>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              ...
                              <textarea  name="script" id="script" class="form-control" style="overflow:scroll;height:150px;max-height:150px"><?php echo set_value('script');?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <select style="width:260px" class="chosen-select" name="ad_area" id="ad_area"/>
                                    ...
                                    <option value="1" <?php echo set_select('ad_area', 1)?>>Home Page Top ( 728 X 90 )</option>
                                    <option value="2" <?php echo set_select('ad_area', 2)?>>Sub Page Left ( 300 X 250 )</option>
                                    <option value="3" <?php echo set_select('ad_area',3)?>>Mobile Ads ( 300x250, 250x250, 200x200 , 320x100, 320x50 )</option>
                                    <option value="4" <?php echo set_select('ad_area',3)?>>Map Banner (320 X 50)</option>
                                </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          ...
                          <div class="col-sm-12">
                            <label class="switch left">
                                <input type="checkbox" value="1" name="show_status" id="show_status">
                               <span></span>
                            </label> 
