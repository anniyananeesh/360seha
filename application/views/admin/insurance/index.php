                      ...
                      <?php if($records):?>
                        ...
                        <?php foreach ($records as $n):?>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php $_id = $this->encrypt->encode($n->ins_id);?>
                              <?php echo $n->ins_title?>
                              </td>
                              <!-- <td>
                                <img src="<?php echo base_url()?>uploads/insurance/<?php echo $n->thumb_url?>" width="150" class="b b-gray img-responsive"/>
                              </td> -->
                              <td>
