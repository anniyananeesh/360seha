          ...
          <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                  ...
                  <select class="form-control" autofocus name="lang" id="lang">
                    <option value="English" <?php echo ($record->not_lang == 'English') ? 'selected':'';?>>English</option>
                    <option value="Arabic" <?php echo ($record->not_lang == 'Arabic') ? 'selected':'';?>>Arabic</option>
                  </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                  ...
                  <input type="text" autocomplete="off" class="form-control" name="title" id="title" value="<?php echo $record->title?>"/>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                  ...
                  <textarea class="form-control" name="message" id="message"/><?php echo $record->message?></textarea>
            ...
            <div class="form-group">
              <div class="col-sm-4">
                <button type="submit" class="btn btn-success btn-lg btn-rounded font-thin">Update</button>
              </div>
            </div>
