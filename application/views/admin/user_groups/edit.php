          ...
          <?php echo $sub_title;?>
                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="post">
                      ...
                      <input type="hidden" name="privs" id="privs" value="<?php echo (string) implode(',', $privileges)?>"/>

                    <div class="form-group">
                        <label class="col-sm-2 control-label"><strong>Group Title</strong></label>
 
                      <div class="col-sm-4">
                          <input type="text" autofocus autocomplete="off" class="form-control" name="grp_title" id="grp_title" value="<?php echo $record->grp_title;?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select style="width:260px" class="chosen-select" name="user_role" id="user_role"/>
                                    ...
                                    <option value="<?php echo ROLE_SEHA_SUPER_ADMINS;?>" <?php if($record->grp_role_id == ROLE_SEHA_SUPER_ADMINS):?> selected="selected"<?php endif;?>>Super Admin</option>
                                    <option value="<?php echo ROLE_SEHA_ADMINS;?>" <?php if($record->grp_role_id == ROLE_SEHA_ADMINS):?> selected="selected"<?php endif;?>>Administrators</option>
                                    <option value="<?php echo ROLE_SEHA_USER;?>" <?php if($record->grp_role_id == ROLE_SEHA_USER):?> selected="selected"<?php endif;?>>Restricted User Privileges</option>
                                              ...
                                              <td>
                                                  ...
                                                  <?php if(is_array($m['actions'])):?>
                                                    ...
                                                    <?php foreach ($m['actions'] as $act):?>
                                                        <a href="" 
                                                           class="btn <?php echo (in_array($m['controller'].'_'.$act, $privileges)) ? 'btn-success' : 'btn-default';?> btn-xs pull-left m-r-xs priv-button" 
                                                           data-priv = "<?php echo $m['controller'].'_'.$act;?>"
