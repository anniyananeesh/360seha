                ...
                <div class="panel-body">
                    ...
                    <script type="text/javascript">
                      ...
                      $(function(){
                          ...
                          $(document).on('change','#dept_id', function(){
                            ...
                            var subsID = $('#subscriber').val(),
                                deptID = $(this).val();

                            $.get('<?php echo HOST_URL?>/admin/async/get_specializations/' + subsID + '/' + deptID, function(res){
                                  ...
                                  if(res.length > 0)
                                  {
                                     ...
                                     $('#spl_id').html(html);
                                     $("#spl_id").trigger("chosen:updated");
                                  }
                                  else
                                  {
                                    $('#spl_id').html('<option value="">Choose</option>');
                                    $("#spl_id").trigger("chosen:updated");
                                  }
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12 p-none"> 
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="clearfix"></div>
                            <input type="text" autocomplete="off" class="form-control" placeholder="" id="dpd1" name="dpd1" value="<?php echo set_value('dpd1');?>"/>
                            <div class="clearfix"></div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="clearfix"></div>
                            <input type="text" autocomplete="off" class="form-control" placeholder="" id="dpd2" name="dpd2" value="<?php echo set_value('dpd2');?>"/>
                            <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 editor-container">
                          ...
                          <textarea name="description_en" class="form-control" style="overflow:scroll;height:100px;"><?php echo set_value('description_en');?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6 editor-container">
                          ...
                          <textarea name="description_ar" class="form-control" style="overflow:scroll;height:100px;"><?php echo set_value('description_ar');?></textarea>
                          <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="clearfix"></div>
                      <div class="col-sm-3"> 
                          <input type="text" autofocus autocomplete="off" class="form-control" name="voucher_code" id="voucher_code" value="<?php echo set_value('voucher_code');?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        ...
                        <label><input type="radio" name="has_points" class="hasPointsChk" value="1" <?php //echo(isset($_POST['has_points']) && $_POST['has_points'] == 1) ? 'checked="checked"': '';?>> Yes</label>&nbsp;&nbsp;
                        <label><input type="radio" name="has_points" class="hasPointsChk" value="0" <?php //echo(isset($_POST['has_points']) && $_POST['has_points'] == 0) ? 'checked="checked"': '';?>> No</label>
 
                      </div>
                      
                    </div>--> 

                    <!-- <div id="showPinboardPoints" style="<?php //echo ($error && isset($_POST['has_points']) && $_POST['has_points'] == 1) ? 'display: block;' : 'display: none;';?>">
                      ...
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              ...
                              <input type="text" style="width: 100px;" name="points" id="points" value="<?php //echo set_value('points')?>" autocomplete="off" class="form-control"/>
                              <div class="clearfix"></div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              ...
                              <input type="text" style="width: 200px;" data-date-format="dd/mm/yyyy" name="expiry" id="expiry" value="<?php echo set_value('expiry')?>" autocomplete="off" class="form-control"/>
                              <div class="clearfix"></div>
