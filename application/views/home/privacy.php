  ...
  <div id="about">
  	<div class="container">
    	<div class="row">
            ...
            <div class="col-lg-12">
            	<h1><?php echo lang('auto.privacy_policy')?></h1>
               <p>The following terms and conditions constitute an agreement between you and Digital Gate Web; 360seha.com. (“360seha.com,” “we,” or “us”), the operator of 360seha.com (the “Site”). These terms of use (the “Terms of Use”) govern your use of the Site, both as a casual visitor and as a registered user. By using the site, and/or by registering with us, you signify that you agree to these terms of use, including that you consent to the information practices disclosed in our Privacy Policy, which is incorporated herein by reference. Please note that we offer the Site "AS IS" and without warranties. If you are registering an account or using the Site on behalf of an individual or entity other than yourself, you represent that you are authorized by such individual or entity to accept these Terms of Use on such individual's or entity's behalf.</p>
