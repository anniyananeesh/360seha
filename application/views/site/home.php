    ...
    <div class="search">
      <form action="<?php echo base_url()?>search/" method="get">
        <div class="input-group">
          ...
          <input type="hidden" name="v" value="featured"/>
          <input type="hidden" name="sort" value="featured"/>
          <input type="hidden" name="category" value=""/>

          <span class="input-group-btn">
            <button class=" searchbutton" type="submit"><img src="<?php echo IMG_PATH?>/home/search.png"></button>
          </span>
        </div>
      </form>
    </div>
  ...
  <div class="category menu">
    <ul>
      ...
      <li><a href="<?php echo HOST_URL?>/search/?country=&city=&v=featured&sort=featured&q=&category=40"><img src="<?php echo IMG_PATH?>/home/labs.png"><br>
        ...
        <li><a href="<?php echo HOST_URL?>/join"><img src="<?php echo IMG_PATH?>/home/getlist.png"><br> <?php echo lang('auto.get_listed')?></a></li>
    </ul>
  </div>
  <div class="social">
    <ul>
...
<script type="text/javascript">
    ...
    // 00AFF0
    var theme_array  = {
        "apple"     : [{"featureType":"all","elementType":"geometry.fill","stylers":[{"hue":"#0080ff"},{"saturation":"250"}]},{"featureType":"all","elementType":"labels.text.fill","stylers":[{"hue":"#0080ff"},{"saturation":"100"},{"lightness":"-33"},{"gamma":"1.33"},{"weight":"3.86"}]},{"featureType":"landscape","elementType":"geometry.fill","stylers":[{"saturation":"100"},{"lightness":"-2"},{"visibility":"on"},{"hue":"#00adff"},{"gamma":"0.84"}]},{"featureType":"landscape","elementType":"labels.text","stylers":[{"hue":"#0080ff"},{"saturation":"57"}]},{"featureType":"landscape","elementType":"labels.icon","stylers":[{"color":"#ff0303"},{"saturation":"100"},{"lightness":"-53"}]},{"featureType":"poi","elementType":"geometry.fill","stylers":[{"hue":"#0080ff"},{"saturation":"94"},{"lightness":"24"}]},{"featureType":"poi.attraction","elementType":"geometry","stylers":[{"visibility":"off"},{"hue":"#00daff"}]},{"featureType":"poi.attraction","elementType":"labels","stylers":[{"hue":"#0085ff"}]},{"featureType":"poi.business","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"poi.medical","elementType":"geometry","stylers":[{"visibility":"off"}]},{"featureType":"poi.medical","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"poi.park","elementType":"labels","stylers":[{"hue":"#0085ff"},{"lightness":"4"}]},{"featureType":"poi.park","elementType":"labels.text","stylers":[{"weight":"4.40"}]},{"featureType":"poi.park","elementType":"labels.text.fill","stylers":[{"hue":"#006eff"},{"visibility":"on"}]},{"featureType":"poi.park","elementType":"labels.text.stroke","stylers":[{"hue":"#00f6ff"}]},{"featureType":"poi.place_of_worship","elementType":"geometry","stylers":[{"visibility":"off"}]},{"featureType":"poi.place_of_worship","elementType":"geometry.fill","stylers":[{"visibility":"off"}]},{"featureType":"poi.place_of_worship","elementType":"geometry.stroke","stylers":[{"visibility":"off"}]},{"featureType":"poi.place_of_worship","elementType":"labels","stylers":[{"visibility":"on"},{"hue":"#0085ff"},{"saturation":"0"},{"lightness":"4"},{"gamma":"1"},{"weight":"4.22"}]},{"featureType":"poi.place_of_worship","elementType":"labels.text","stylers":[{"hue":"#0074ff"}]},{"featureType":"poi.place_of_worship","elementType":"labels.text.fill","stylers":[{"hue":"#006eff"}]},{"featureType":"poi.place_of_worship","elementType":"labels.text.stroke","stylers":[{"visibility":"off"},{"hue":"#00f6ff"}]},{"featureType":"poi.school","elementType":"geometry","stylers":[{"visibility":"off"}]},{"featureType":"poi.school","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"road","elementType":"geometry","stylers":[{"lightness":50},{"visibility":"simplified"}]},{"featureType":"road","elementType":"geometry.fill","stylers":[{"visibility":"on"}]},{"featureType":"road","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"road","elementType":"labels.text.fill","stylers":[{"visibility":"off"}]},{"featureType":"road.arterial","elementType":"geometry.fill","stylers":[{"hue":"#0080ff"},{"saturation":"92"},{"lightness":"4"}]},{"featureType":"road.local","elementType":"geometry.fill","stylers":[{"hue":"#0080ff"},{"saturation":"100"},{"lightness":"4"}]},{"featureType":"transit","elementType":"geometry.fill","stylers":[{"hue":"#0080ff"}]}]
    };
