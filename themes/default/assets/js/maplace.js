        ...
        */
        ...
        Maplace.prototype.add_markerEv = function (index, point, marker) {
            ...
            google.maps.event.addListener(marker, 'click', function (ev) {
                ...
                $.post('http://localhost/livework/360seha.com/async/updateMrkrClick',{'u': parseInt(marker.user)}, function(res){},'json');
...
//                this.o.afterOpenInfowindow(index, point, marker);
			...
			,maxWidth: 0
                        ...
                        ,closeBoxMargin: '29px -90px 0 63px'
			...
			,closeBoxURL: "http://360seha.com/themes/default/assets/img/223/map-close.png"
			,infoBoxClearance: new google.maps.Size(1, 1)

		};
                var iB = new InfoBox(myOptions);
		iB.open(this.oMap, marker);
